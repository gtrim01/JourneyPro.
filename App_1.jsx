...
/* ============================================================
   JourneyPro — Prototype v0.31 (leg sheet breathing room)
   · Fix: on phones, stop names were being crushed to a letter
     when the Roadhouse tag and a fill chip shared the row —
     the row now wraps, so Glendambo gets its name back and
     the chips sit neatly beneath
   · Plus everything from v0.30
