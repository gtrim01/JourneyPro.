...
/* ============================================================
   JourneyPro — Prototype v0.32 (fill chips on their own line)
   · The amber FILL chip now lives on its own line beneath the
     town name — nothing overlaps, every name reads in full,
     exactly as it should have been
   · Plus everything from v0.31
  ...
  return (
    <div className="jp-root min-h-screen w-full" data-tab={tab}>
      <style>{`
        ...
        .jp-fillline { margin: 0.2rem 0 0.1rem 1.55rem; }
